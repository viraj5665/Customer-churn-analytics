...
# ── 1. LOAD CSV ──────────────────────────────────────────
df = pd.read_csv('/Users/virajpatel/Desktop/churn_analytics_project/data/telco_churn.csv')
print(f"Rows loaded: {len(df)}")
print(df.head())

# ── 2. LOAD INTO SQLITE DATABASE ─────────────────────────
conn = sqlite3.connect('/Users/virajpatel/Desktop/churn_analytics_project/data/telco_churn.csv')
